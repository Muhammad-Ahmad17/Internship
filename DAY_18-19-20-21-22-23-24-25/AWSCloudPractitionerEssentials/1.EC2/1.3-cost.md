...
| Pricing Model       | Key Point / Best For                                                                 |
|---------------------|---------------------------------------------------------------------------------------|
| On-Demand           | Pay-as-you-go, no commitment. Best for short-term, unpredictable workloads.          |
| Reserved Instances  | Up to 75% savings. 1–3 year commitment. Best for steady/predictable workloads.       |
| Spot Instances      | Up to 90% off. Can be interrupted. Best for fault-tolerant, flexible workloads.      |
| Savings Plans       | Up to 72% savings. Commit to consistent usage (1–3 years). Flexible across services. |
| Dedicated Hosts     | Entire physical server. Best for compliance, licensing, strict isolation.            |
| Dedicated Instances | Hardware isolation (not full server). Best for isolated workloads without full host. |
...
| Option                        | Good For                  | Commitment        | Pricing / Savings                         | Flexibility                                    | Services Covered                     |
|-------------------------------|---------------------------|-------------------|-------------------------------------------|-----------------------------------------------|--------------------------------------|
| Savings Plans                 | Predictable workloads     | 1 or 3 years      | Up to 72% savings vs On-Demand            | Applies across EC2, Fargate, Lambda, SageMaker | EC2, Fargate, Lambda, SageMaker       |
| Capacity Reservations         | Critical workloads needing guaranteed AZ capacity | None (On-Demand billing) | Pay On-Demand rate (charged even if unused) | Reserved capacity in a chosen AZ               | EC2 only                             |
| Reserved Instance Flexibility | Steady-state workloads    | 1 or 3 years      | Up to 75% savings vs On-Demand            | Applies across instance sizes + multiple AZs   | EC2 only                             |
...
|----------------------|----------------------------------------------------|-------------------------------------------------|
| Good For             | Predictable workloads with flexibility             | Steady-state workloads with predictable usage   |
| Commitment           | 1 or 3 years (commit $/hr spend)                   | 1 or 3 years (commit to instance family/region) |
| Pricing / Savings    | Up to 72% savings vs On-Demand                     | Up to 75% savings vs On-Demand                  |
| Flexibility          | Applies across EC2, Fargate, Lambda, SageMaker; flexible across instance types, regions | Applies only to EC2, but discounts can apply across sizes & AZs in same family |
| Payment Options      | All upfront, Partial upfront, No upfront           | All upfront, Partial upfront, No upfront        |
| Services Covered     | EC2, Fargate, Lambda, SageMaker                    | EC2 only                                        |
| Best Choice When     | You want **service + region flexibility**          | You want **maximum EC2-specific discount**      |
