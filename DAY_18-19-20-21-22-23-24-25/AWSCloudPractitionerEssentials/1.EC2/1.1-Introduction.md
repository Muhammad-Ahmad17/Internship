...
| Instance Type          | Use Case / Description                                                                 | Example Families |
|------------------------|-----------------------------------------------------------------------------------------|------------------|
| General purpose        | Balanced compute, memory, networking; good for diverse workloads (web services, code repos). | t3, t4g, m5, m6g |
| Compute-optimized      | Compute-intensive tasks (gaming servers, HPC, ML, scientific modeling).                  | c5, c6g, c7g     |
| Memory-optimized       | Memory-intensive tasks; fast performance for large in-memory datasets.                   | r5, r6g, x1, z1d |
| Accelerated-computing  | Floating point calculations, graphics, data pattern matching with hardware accelerators. | p3, p4, g4, g5, f1 |
| Storage-optimized      | High performance for locally stored data.                                                | i3, i4i, d2, h1  |
